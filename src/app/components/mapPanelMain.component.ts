...
@Component({
    selector: 'mapPanelMain',
    templateUrl: '../templates/mapPanelMain.component.html',
    styleUrls: ['../styles/mapPanel.component.css', '../styles/mainPanel.component.css']
})
export class MapPanelMainComponent implements OnInit {
    //Listeners 
